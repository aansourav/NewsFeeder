      ...
      {dir === "left" ? (
        <>
          <div className="col-span-12 lg:col-span-4">
            ...
            <p className="mt-5 text-base text-[#5C5955]">{getFormatDate(new Date(publishedAt))}</p>
          </div>

          <div className="col-span-12 lg:col-span-8">
            {urlToImage !== null && <img className="w-full mb-3" src={urlToImage} alt="thumb" />}
            {urlToImage !== null && (
        ...
        <>
          {urlToImage !== null && <img className="w-full" src={urlToImage} alt="thumb" />}
          ...
          <div className="col-span-12 mt-6 md:col-span-4">
            ...
            <p className="mt-5 text-base text-[#94908C]"> {getFormatDate(new Date(publishedAt))}</p>
          </div>
        </>
      )}
    </div>
